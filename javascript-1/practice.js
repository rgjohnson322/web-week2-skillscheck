...
// Create an object called 'me' that has these keys with the correct values: firstName, state, age, greeter. firstName will
//be your name as a string. state will be your current state or providence as a string. age will be your age as a number. greeter
...
//Loop over the passed in arr param. If the number is GREATER than 100, push 'big' as a string to the answers array. If the number is 
...
// Last, lets use .forEach to find the index of each item in the array. First, create an empty array called myNumbersIndex. Next, using 
//forEach, push each items index from the myNumbers array to the myNumbersIndex array

// Code Here
myNumbersIndex = [];
	function iterate(item, index){
		myNumbersIndex(index)
	}
...
// Code Here
// let forTheLoveOfGeorge = notGeorge.map(function(item) {
// 	return "George"
// }
